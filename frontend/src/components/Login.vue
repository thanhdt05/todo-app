    ...
    >
      ...
      <div class="mt-4 space-y-2">
        <div class="relative flex py-2 items-center">
          ...
          <span class="flex-shrink mx-4 text-xs font-semibold text-gray-400 uppercase"
        ...
        <div class="grid grid-cols-2 gap-3 pt-1">
          <button
            ...
            class="flex items-center justify-center px-4 py-2.5 bg-[#0078d4] hover:bg-[#006cbd] text-white font-medium text-sm rounded-xl shadow-sm hover:shadow transition duration-150 cursor-pointer"
          >
            <svg class="w-4 h-4 mr-2 shrink-0" viewBox="0 0 23 23">
          ...
          <button
            ...
            class="flex items-center justify-center px-4 py-2.5 bg-white hover:bg-gray-50 border border-gray-300 text-gray-700 font-medium text-sm rounded-xl shadow-sm hover:shadow transition duration-150 cursor-pointer"
          >
            <svg class="w-4 h-4 mr-2 shrink-0" viewBox="0 0 48 48">
              <path
                fill="#EA4335"
